...
## What does Git actually track? {#sec-git-diff}

Git compares versions of your files.

```diff
- This sentence was here before.
+ This sentence has changed.
```
...
## Live demo: Positron's Source Control pane {#sec-git-positron}
...
## Commit messages are for future readers {#sec-commit-messages}
...
## One sentence per line {#sec-one-sentence}
...
## Push: send your commits to GitHub {#sec-git-push}
