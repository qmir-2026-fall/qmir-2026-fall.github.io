...
- **Q**uarto **M**ark**d**own (**`.qmd`**) files have two main parts:
  - **YAML header**: Contains metadata and controls how Quarto processes the document.
    It appears at the top of the file and is enclosed by `---`.
...
::: {.callout-note}
This also provides a transparent way to communicate which changes were made with the help of AI.
