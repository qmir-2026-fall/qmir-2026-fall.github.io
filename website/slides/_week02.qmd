---
title: "Week 2: Reproducible literate programming with Quarto and Git"
---
...
<!-- ─────────────────────────────────────────────────────────────────────────────
     MOVED HERE FROM week01.qmd on 2026-09-07. Week 1 closes with a distribution
     recap instead, and the environment belongs in this session.

     Unlike the rest of this staging file, these two slides are already written to
     STYLE.md, so they can go into week02.qmd unchanged when this deck is converted.
     ───────────────────────────────────────────────────────────────────────────── -->

# First glance at Positron {#sec-positron}
