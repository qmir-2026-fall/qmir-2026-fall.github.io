...
`uma-palace-title.jpg` is a downscaled derivative of `uma_palace.png`, used as the deck title-slide background. It falls under exactly the same University of Mannheim terms as the source photograph.
