...
<!-- This README ships to students in the distribution repo. Keep the policy banner verbatim.
     ...
     the starter, hw-07.qmd. Write the task section from the
...
- Complete `hw-07.qmd` and render it to PDF.
- Commit and push to your `hw-07-<username>` repo. **Rendering and pushing is your submission.**
