...
<One or two paragraphs stating the question and the deliverable.
Reference the 8-step workflow stages this homework exercises (see the course slides).>

## What to submit

- Complete `hw-NN.qmd` and render it to PDF.
- Commit and push to your `hw-NN-<username>` repo.
